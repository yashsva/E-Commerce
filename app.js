...
// const privateKey=fs.readFileSync('server.key');    //this file(server.key) is deleted
// const certificate=fs.readFileSync('server.cert');  //this file(server.cert) is deleted
